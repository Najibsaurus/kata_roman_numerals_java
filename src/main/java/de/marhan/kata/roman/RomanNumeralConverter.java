...
public class RomanNumeralConverter {
	...
	/**
	 * Calculate the difference of prefix and the arabic numeral to converts it by recursion.
	 * 
	 * @param arabicNumeral The original arabic numeral to convert.
	 * @param prefixValue The first roman numeral, which was found.
	 * @return
	 */
	...
	NumeralMappingElement findMappingForArabic(Integer arabicNumeral) {
		...
		String errorMessage = String.format("'%s' is not defined in range of mappings", arabicNumeral);
