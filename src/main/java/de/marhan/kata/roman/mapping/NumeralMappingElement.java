...
public class NumeralMappingElement {
	 ...
	 * 
	 * @param before The mapping of the lower numeral.
	 * @param arabic The arabic numeral.
	 * @param roman The roman numeral.
	 * @return The created element.
	 */
	static NumeralMappingElement newInstance(NumeralMappingElement before, Integer arabic, String roman) {
